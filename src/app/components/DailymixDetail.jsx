...
const DailymixDetail = () => {
  ...
  return (
    <div className="">
      {/* web version */}
      <div className="hidden sm:block overflow-y-scroll h-[80%] ">
        ...
        <div className=" grid grid-cols-12 border-b  px-2 border-gray-500 mb-4 pb-4 ">
      ...
      <div className="block sm:hidden  ">
        <div className=" h-[250px] ">
          ...
          <p className=" text-xl font-bold mt-4 px-3">{data?.title}</p>
        </div>
